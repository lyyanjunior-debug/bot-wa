...
const config = {
  ...
  owner: {
    name: "Lyyan Junior ", // Nama owner
    number: ["6285156611767"], // Format: 628xxx (tanpa + atau 0)
  },

  session: {
    pairingNumber: "6285719582184", // Nomor WA yang akan di-pair, ini penting
    usePairingCode: true, // true = Pairing Code, false = QR Code
  },

  bot: {
    name: "OKTA BOT", // Nama bot
